      ...
      <a-layout-header
        ...
        <div v-if="mode === 'sidemenu'" class="header">
          ...
          >
            ...
            <a-menu-item v-for="(item,index) in userInfo.apps" :key="index" style="top:0px; line-height: 55px; padding-left: 10px; padding-right: 10px">
              {{ item.name }}
            </a-menu-item>
            <user-menu></user-menu>
          </a-menu>
...
export default {
  ...
  created () {
    console.log('------------code=' + Vue.ls.get(ALL_APPS_MENU)[0].code)
