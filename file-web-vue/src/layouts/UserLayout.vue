  ...
  <div id="userLayout" :class="['user-layout-wrapper', device]">
    <div class="container">
      <div class="top">
        <div class="header">
          <a href="/">
            <img src="~@/assets/whale_logo.png" class="logo" alt="logo">
            <span class="title">Gallop 文件管理系统</span>
          </a>
        </div>
        <div class="desc">
      ...
      <div class="footer">
        ...
        <div class="copyright">
          Copyright © 2021 <a target="_blank" href="https://www.mygallop.cn">Gallop</a> All rights reserved.
        </div>
      </div>
    </div>
  </div>
